...
a persistence unit "unawebappPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "unawebapp/pom.xml":
...
artifact ("unawebapp.war") is already built. You can build
